        ...
        <div style={{ padding: 10 }} class='for_main_div'>
            ...
            <div class='text-opacity'>
                ...
                <p class='perenos'>
                    ...
                    <ul>
                        <li>
                            <b style={{ fontFamily: 'MyCustomFont', fontSize: '32px' }}>Расписание</b><br />
                        ...
                        <li>
                            <b style={{ fontFamily: 'MyCustomFont', fontSize: '32px' }}>Домашние задания</b><br />
                        ...
                        <li>
                            <b style={{ fontFamily: 'MyCustomFont', fontSize: '32px' }}>Новости колледжа</b><br />
