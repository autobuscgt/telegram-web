...
function Main() {
    ...
    return (
        <div style={{ padding: 10 }} class='for_main_div'>
            <p style={{ fontFamily: 'MyCustomFont', fontSize: '32px' }}>
            {
                !data ?"Loading" : data
            }
            </p>
            <h1 style={{ fontFamily: 'MyCustomFont', fontSize: '32px' }} className='text-load' data-text="Добро пожаловать в">
                Добро пожаловать в<br />
            </h1>
            <h1 style={{ fontFamily: 'MyCustomFont', fontSize: '32px' }} className='text-load' data-text="WEB-ПРИЛОЖЕНИЕ MKIT!">
                WEB-ПРИЛОЖЕНИЕ MKIT!
            </h1>
